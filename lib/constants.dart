...
const Color bleuMarocain = Color(0xFF1C8B6C);
...
List<String> imams = [
  "Talib Djily Cheikh Abou Maymouna / الطالب جيلي شيخ أبو ميمونة",
  "Talib Ismaïl Ibn Hādī / الطالب اسماعيل بن هادي",
  "Talib Mehdi Abou Abdilleh / الطالب مهدي بن ناصر",
  "Talib Samy Philippe Chaouche / الطالب سامي بن عبد الكريم الشاوش",
  "Talib Tahir Abu Sany / الطالب طاهر أبو سني",
];
